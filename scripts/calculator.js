function equivalentCheck() { //This allows the value to remain in view until another value is set 
...
function input(x) {
    ...
    if (document.getElementById('decimalVar').value == 0){
        ...
        x += y * 10 //multiply the text input by 10 then add the value of x. 
...
function decimalPoint(){
    ...
    if(parseInt(document.getElementById('operation').value)){ //if this is an empty string, it will retun false
        document.getElementById('result').value = 0; 
    }
}
